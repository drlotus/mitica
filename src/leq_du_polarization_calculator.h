...
{
    class leq_du_polarization_calculator : public powerhouse::I_calculator<vhlle::fcell,
    ...
    double leq_du_polarization_calculator::b;
    double leq_du_polarization_calculator::q;
    double leq_du_polarization_calculator::s;
    double leq_du_polarization_calculator::spin;
    double leq_du_polarization_calculator::stat;
    double leq_du_polarization_calculator::phase_space;
}