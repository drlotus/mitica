...
namespace powerhouse
{
    ...
    double leq_db_polarization_calculator::b;
    double leq_db_polarization_calculator::q;
    double leq_db_polarization_calculator::s;
    double leq_db_polarization_calculator::spin;
    double leq_db_polarization_calculator::stat;
    double leq_db_polarization_calculator::phase_space;
}